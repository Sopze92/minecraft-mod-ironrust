...
public class ModBlocks {
  ...
  static {
    ...
    // IRON_TRAPDOOR
    COATED_IRON_TRAPDOOR = _register("coated_iron_trapdoor", (settings) -> new TrapDoorBlock(BlockSetType.IRON, settings), BlockBehaviour.Properties.of().mapColor(COATED_IRON_BLOCK.defaultMapColor()).strength(5.0F).requiresCorrectToolForDrops().noOcclusion().isValidSpawn(Blocks::never));
