...
public class ModItems {
  ...
  private static DeferredRegister.Items ITEMS= DeferredRegister.createItems(MOD_ID);

  private static final DeferredHolder<Item, ? extends Item>
    ACTIVE_HONEYCOMB,
  // ITEM BLOCKS
  ...
  public static void initializeAfter() {
    DispenserBlock.registerBehavior(ACTIVE_HONEYCOMB.get(), new OptionalDispenseItemBehavior() {
      @Override
  ...
  private static void _insertAfter(BuildCreativeModeTabContentsEvent event, ItemLike target, DeferredHolder item, CreativeModeTab.TabVisibility visibility){
    event.insertAfter(target.asItem().getDefaultInstance(), ((DeferredHolder<Item, ? extends Item>)item).get().getDefaultInstance(), visibility);
  }
  ...
  private static void _insertAllAfter(BuildCreativeModeTabContentsEvent event, ItemLike target, Collection<DeferredHolder> items, CreativeModeTab.TabVisibility visibility){
    for(DeferredHolder<Item, ? extends Item> i : items){
      event.insertAfter(target.asItem().getDefaultInstance(), i.get().getDefaultInstance(), visibility);
    }
  }
  ...
  public static void onBuildCreativeTabContents(BuildCreativeModeTabContentsEvent event){
    ...
    if(groupKey == CreativeModeTabs.INGREDIENTS){
      ...
      _insertAllAfter(event, Blocks.IRON_CHAIN, Arrays.stream(new DeferredHolder[] {
        EXPOSED_IRON,
        EXPOSED_IRON_GRATE,
        EXPOSED_IRON_BARS,
        EXPOSED_IRON_DOOR,
      ...
      _insertAllAfter(event, Blocks.IRON_DOOR, Arrays.stream(new DeferredHolder[] {
        EXPOSED_IRON_DOOR,
        WEATHERED_IRON_DOOR,
        OXIDIZED_IRON_DOOR,
        COATED_IRON_DOOR,
      ...
      _insertAllAfter(event, Blocks.IRON_TRAPDOOR, Arrays.stream(new DeferredHolder[] {
        EXPOSED_IRON_TRAPDOOR,
        WEATHERED_IRON_TRAPDOOR,
        OXIDIZED_IRON_TRAPDOOR,
        COATED_IRON_TRAPDOOR,
